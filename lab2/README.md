...
2. 下面的例子也是输出“Hello World”，而且比示例更加简单。但是，由于TA时常在凌晨4点时为同学们编写tutorial，导致下面的代码是在意识不清醒的情况下写出的。显然，代码无法输出TA想要的结果。TA因为提早了睡眠时间，无法进行debug工作，恳请同学们帮助TA完成这一过程。同学们需要完成的任务如下。
